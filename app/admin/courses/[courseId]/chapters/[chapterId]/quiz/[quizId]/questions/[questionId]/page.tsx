...
import { ArrowLeft, LayoutDashboard, ListChecks, Eye } from "lucide-react";
...
export default async function QuestionIdPage({
  ...
  params: Promise<{ courseId: string; chapterId: string; quizId: string; questionId: string }>
}) {
  const { courseId, chapterId, quizId, questionId } = await params;
      ...
      <div className="p-6 m-5 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div className="flex items-center justify-between">
          <div className="w-full">
            <Link
              href={`/admin/courses/${courseId}/chapters/${chapterId}/quiz/${quizId}`}
