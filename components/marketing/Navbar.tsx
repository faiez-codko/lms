...
export const Navbar = () => {
  return (
    <div className="fixed top-0 w-full h-20 px-4 border-b border-slate-800 bg-[#383838] backdrop-blur-sm z-50 flex items-center justify-between">
      <div className="md:max-w-screen-2xl mx-auto flex items-center w-full justify-between">
        ...
        <div className="hidden md:flex items-center gap-x-6 mr-6 text-slate-300">
          ...
          <Link href="/browse" className="hover:text-emerald-400 transition">
            Course
          </Link>
